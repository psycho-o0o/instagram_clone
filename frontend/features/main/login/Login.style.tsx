...
export const LoginInputWrapper = styled.div`
    margin: 0 40px 6px;
`;
export const LoginInputWrap = styled.div<DefaultTheme>`
    width: 100%;
    ...
    position: relative;
`;
export const LoginInputLabel = styled.label<ILoginInputLabel & DefaultTheme>`
    flex: 1 0 0;
    min-width: 0;
    height: 36px;
    margin: 0;
...
export const ToggleWrap = styled.div<IToggleWrap & DefaultTheme>`
    margin-left: 8px;
    display: ${(props) =>
        props.isEmpty !== undefined && props.isEmpty === true
            ? 'none'
            : 'flex'};
...
export const LoginButtonWrapper = styled.div`
    ...
    flex: 0 0 auto;
`;
export const LoginButton = styled.button<ILoginButton & DefaultTheme>`
    ${(props) =>
        props.isPossibleLogin
            ? css`
                  opacity: 1;
                  cursor: pointer;
              `
